...
struct TimeoutComp {
    timeout: Vec<f64>,
    max_nodes: Vec<u64>,
    normal_nodes: Vec<u64>,
    discrepancy_nodes: Vec<u64>,
    normal_run: Vec<f64>,
    discrepancy_run: Vec<f64>,
}

impl TimeoutComp {
    pub fn new(timeout: Vec<f64>, max_nodes: Vec<u64>, normal_nodes: Vec<u64>, discrepancy_nodes: Vec<u64>, normal_run: Vec<f64>, discrepancy_run: Vec<f64>) -> TimeoutComp {
        TimeoutComp {
            timeout,
            max_nodes,
            normal_nodes,
            ...
            for use_discrepancy in [false, true] {
                ...
                while timeout <= 120. {
                    ...
                    if use_discrepancy {
                        ...
                        max_nodes_vec.push(output.0.max_cachesize);
